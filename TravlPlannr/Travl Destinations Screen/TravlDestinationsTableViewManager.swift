...
extension TravlDestinationsViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if (locationNames[indexPath.row] == "Current Location") {
            ...
            let destination = Destination(name: selectedName, latitude: selectedLocation.coordinate.latitude, longitude: selectedLocation.coordinate.longitude)
    ...
    func promptUserToNameLocation() {
        ...
        let nameLocationAction = UIAlertAction(title: "Confirm", style: .default, handler: {(_) in
